...
RESEARCH = {
    ...
    "angles": [
        ...
        {"id": "A4", "name": "בלי מים. בלי אדים. רק ריח.", "idea": "הטכנולוגיה כיתרון: אידוי שמן בושם טהור, שליטה מהנייד, תזמון לפי ימים ושעות.", "persona": "הבית כמלון", "hook": "ריח שמרגישים מהרגע הראשון.", "why": "עונה על ההתנגדות הכי גדולה ('זה בכלל מורגש?') וממצב מול מפיצי אדים זולים."},
...
ad(15, "A4", "9:16", ["b150w"],
   ...
   "ריח שממלא<br>את כל החלל.", "עד 150 מ״ר · 599 ש״ח",
   ...
   "ריח שממלא את כל החלל. B-150 עם 100 מ״ל שמן.",
   "ריח שממלא את החלל", "B-150 · 599 ש״ח")
